...
export default function ProgressRing({
  ...
  return (
    ...
    >
      <div className="flex h-full w-full flex-col items-center justify-center rounded-full bg-[color:var(--card)] text-center">
        ...
        {subtitle ? (
          <div className="text-[10px] text-[color:var(--muted)]">{subtitle}</div>
        ) : null}
      </div>
    </div>
  );
